...
class Forgotpassword extends CI_Controller {
		...
		public function newpassword()
		{
			...
			if($success['result']==0)
			{
				header("Location: <?php echo base_url();?>forgotpassword?success=0");
				//echo 0;
...
<p><a href="<?php echo base_url();?>index.php/login">Please click on this link to verify your Login.</a></p>
<br>
...
<p>Kind regards,<br>Inubaan Software Team</p>
				...
				header("Location: <?php echo base_url();?>forgotpassword?success=1");
