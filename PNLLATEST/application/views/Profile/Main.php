	                        ...
	                        <div modal="showModal" close="cancel()" class="modal-content" style="display: block;background-color: #fff;">
									...
									<div class="modal-body" style="min-height: 403px;"> 
										...
										<!--<div class="col-md-2 no-pad topmar" style="width: 16.66667%;">
											 <form action="<?php echo base_url();?>index.php/Affiliate/index" method="POST" id="payment-form">
											 <img class="top1" src="<?php echo base_url();?>images/1.png" style="width: 116%;margin: 2px 0px 0px -11px;display: block;">
											  <div class="allbox box1" style="border: 4px #005e5e solid;">
												...
												Affiliate Accoun
												  ...
												  <div class="txtlft">
												  <img src="<?php echo base_url();?>images/AM1.png" class="cstmbullet" style="height: 20px;width: 20px;float: left;margin: 5px;">  5 Store <br><br>
												  
												  <img src="<?php echo base_url();?>images/AM1.png" class="cstmbullet" style="height: 20px;width: 20px;float: left;margin: 5px;"> 5 FB Ads Account  <br><br>
												  
												  <img src="<?php echo base_url();?>images/AM1.png" class="cstmbullet" style="height: 20px;width: 20px;float: left;margin: 5px;">Affiliate Commission<br><br>
												  ...
												  <input class="btn1" src="<?php echo base_url();?>images/B1.png" alt="Submit" style="width: 80%;margin: auto;position: relative;bottom: -21px;" type="image">
										...
										<div class="col-md-2 no-pad topmar" style="width: 18.667%;margin: 14px 0 0 107px;">
											 <form action="<?php echo base_url();?>stripepaymentupgrade" method="POST" id="payment-form">
											 <img class="top1" src="<?php echo base_url();?>images/2.png" style="width: 116%;margin: 2px 0px 0px -11px;display: block;">
											  <div class="allbox box1" style="border: 4px #602d91 solid;">
												...
												<div class="frmtext1" style="background: #602d91;width: 100%;margin: 10px 0;padding: 5px 10px;color: white;font-size: 10px;">
												 Basic Account
												  ...
												  <div class="txtlft">
												  <img src="<?php echo base_url();?>images/BM1.png" class="cstmbullet" style="height: 20px;width: 20px;float: left;margin: 5px;">  1 Store <br><br>
												  
												  <img src="<?php echo base_url();?>images/BM1.png" class="cstmbullet" style="height: 20px;width: 20px;float: left;margin: 5px;"> 1 FB Ads Account  <br><br>
												  
												  <img src="<?php echo base_url();?>images/BM1.png" class="cstmbullet" style="height: 20px;width: 20px;float: left;margin: 5px;">Simulator<br><br>
												  ...
												  <input class="btn1" src="<?php echo base_url();?>images/B2.png" alt="Submit" style="width: 80%;margin: auto;position: relative;bottom: -21px;" type="image">
										...
										<div class="col-md-2 no-pad topmar" style="width: 18.667%;margin: 14px 0 0 107px;">
											 <form action="<?php echo base_url();?>stripepaymentupgrade" method="POST" id="payment-form">
											 <img class="top1" src="<?php echo base_url();?>images/3.png" style="width: 116%;margin: 2px 0px 0px -11px;display: block;">
											  <div class="allbox box1" style="border: 4px #2e3192 solid;">
												...
												<div class="frmtext1" style="background: #2e3192;width: 100%;margin: 10px 0;padding: 5px 10px;color: white;font-size: 10px;">
												 Basic Account
												  ...
												  <div class="txtlft">
												  <img src="<?php echo base_url();?>images/cM1.png" class="cstmbullet" style="height: 20px;width: 20px;float: left;margin: 5px;">  3 Store <br><br>
												  
												  <img src="<?php echo base_url();?>images/cM1.png" class="cstmbullet" style="height: 20px;width: 20px;float: left;margin: 5px;"> 3 FB Ads Account  <br><br>
												  
												  <img src="<?php echo base_url();?>images/cM1.png" class="cstmbullet" style="height: 20px;width: 20px;float: left;margin: 5px;">Simulator<br><br>
												  ...
												  <input class="btn1" src="<?php echo base_url();?>images/B3.png" alt="Submit" style="width: 80%;margin: auto;position: relative;bottom: -21px;" type="image">
												  <input name="user_id" value="<?php echo $subscription[0]->user_id;?>" type="hidden">
												  <input name="str_customer_id" value="<?php echo $subscription[0]->str_id;?>" type="hidden">
												   <input name="stripe_payment_history_id" value="<?php echo $subscription[0]->id;?>" type="hidden">
										...
										<div class="col-md-2 no-pad topmar" style="width: 18.667%; margin: 14px 0 0 107px;">
											 <form action="<?php echo base_url();?>stripepaymentupgrade" method="POST" id="payment-form">
											 <img class="top1" src="<?php echo base_url();?>images/4.png" style="width: 116%;margin: 2px 0px 0px -11px;display: block;">
											  <div class="allbox box1" style="border: 4px #00aaad solid;">
												...
												<div class="frmtext1" style="background: #00aaad;width: 100%;margin: 10px 0;padding: 5px 10px;color: white;font-size: 10px;">
												 Basic Account
												  ...
												  <div class="txtlft">
												  <img src="<?php echo base_url();?>images/dM1.png" class="cstmbullet" style="height: 20px;width: 20px;float: left;margin: 5px;">  5 Store <br><br>
												  
												  <img src="<?php echo base_url();?>images/dM1.png" class="cstmbullet" style="height: 20px;width: 20px;float: left;margin: 5px;"> 5 FB Ads Account  <br><br>
												  
												  <img src="<?php echo base_url();?>images/dM1.png" class="cstmbullet" style="height: 20px;width: 20px;float: left;margin: 5px;">Simulator<br><br>
												  ...
												  <input class="btn1" src="<?php echo base_url();?>images/B4.png" alt="Submit" style="width: 80%;margin: auto;position: relative;bottom: -21px;" type="image">
												  <input name="user_id" value="<?php echo $subscription[0]->user_id;?>" type="hidden">
												  <input name="str_customer_id" value="<?php echo $subscription[0]->str_id;?>" type="hidden">
												   <input name="stripe_payment_history_id" value="<?php echo $subscription[0]->id;?>" type="hidden">
									   ...
									   <?php 
										 ...
										 else
										 {
											 ...
											 if($subscriptionname=='affiliate')
											 {
												 ...
												 <tbody>
													<tr  class="rpttext2">
													  ...
													  <a href="<?php echo base_url();?>subscription/index/<?php echo $user_info->user_interanal_id;?>/zgQl2Knc" target="_blank">Upgrade</a></th>
													</tr>
											 ...
											 if($subscriptionname=='plan1A')
											 {
												...
												<tbody>
													<tr  class="rpttext2">
													  <th class="col-sm-2 greene" style="color: red !important;">Basic Monthly</th>
													  <th class="col-sm-2 greene">1 Store/1 FB Ads</th>
													  <th class="col-sm-2 greene"><?php echo $subscription[0]->created_at;?></th>
													   <th class="col-sm-2 greene" style="color: red !important;">
													   <?php 
											 ...
											 if($subscriptionname=='plan1B')
											 {
												 ...
												 $byaffiliate_refaral=$user_info->byaffiliate_refaral;
												
												if($byaffiliate_refaral>0)
												{ ?>
											<tbody>
													<tr  class="rpttext2">
													  <th class="col-sm-2" style="color: red !important;">Basic Yearly</th>
													  <th class="col-sm-2 greene">1 Store/1 FB Ads</th>
													  <th class="col-sm-2 greene"><?php echo $user_info->user_account_created_on ;?></th>
													  <th class="col-sm-2" style="color: red !important;">Active</th>
											...
											<?php
												...
												?>
												  <tbody>
													<tr  class="rpttext2">
													  <th class="col-sm-2 greene" style="color: red !important;">Basic Yearly</th>
													  <th class="col-sm-2 greene">1 Store/1 FB Ads</th>
													  <th class="col-sm-2 greene"><?php echo $subscription[0]->created_at;?></th>
													   <th class="col-sm-2 greene" style="color: red !important;">
													   <?php 
											 ...
											 if($subscriptionname=='plan2A')
											 {
												 ...
												 ?>
												  ...
												  <tbody>
													<tr  class="rpttext2">
													  <th class="col-sm-2 greene" style="color: red !important;">Professional Monthly</th>
											 ...
											 if($subscriptionname=='plan2B')
											 {
												...
												?>
												  ...
												  <tbody>
													<tr  class="rpttext2">
													  <th class="col-sm-2 greene" style="color: red !important;">Professional Yearly</th>
													  <th class="col-sm-2 greene">3 Store/3 FB Ads</th>
													  <th class="col-sm-2 greene"><?php echo $subscription[0]->created_at;?></th>
													   <th class="col-sm-2 greene" style="color: red !important;">
													   <?php 
											 ...
											 if($subscriptionname=='plan3A')
											 {
												...
												?>
												  ...
												  <tbody>
													<tr  class="rpttext2">
													  <th class="col-sm-2 greene" style="color: red !important;">Business Monthly</th>
													  <th class="col-sm-2 greene">5 Store/5 FB Ads</th>
													  <th class="col-sm-2 greene"><?php echo $subscription[0]->created_at;?></th>
													   <th class="col-sm-2 greene" style="color: red !important;">
													   <?php 
											 ...
											 if($subscriptionname=='plan3B')
											 {
												...
												?>
												  ...
												  <tbody>
													<tr  class="rpttext2">
													  <th class="col-sm-2 greene" style="color: red !important;">Business Yearly</th>
													  <th class="col-sm-2 greene">5 Store/5 FB Ads</th>
													  <th class="col-sm-2 greene"><?php echo $subscription[0]->created_at;?></th>
													   <th class="col-sm-2 greene" style="color: red !important;">
													   <?php 
											 ...
											 if($subscriptionname=='M1')
											 {
												...
												?>
												  ...
												  <tbody>
													<tr  class="rpttext2">
													  <th class="col-sm-2 greene" style="color: red !important;">Monthly</th>
													  <th class="col-sm-2 greene">Subscription Payment Monthly</th>
													  <th class="col-sm-2 greene"><?php echo $subscription[0]->created_at;?></th>
													   <th class="col-sm-2 greene" style="color: red !important;">
													   <?php 
													    $currentdate=date('Y-m-d H:i:s');
													   ...
													   <th class="col-sm-2 greene">$29 / Monthly</th>
													   <th class="col-sm-2 greene">
													   <a href="javascript:void(0);" 
													   ng-click="canclesubscription(<?php echo $subscription[0]->user_id;?>,'<?php echo $subscription[0]->str_id;?>','<?php echo $subscription[0]->str_sub_id;?>')">Cancle</a>
													   /<!--<a href="javascript:void(0);" ng-click="showupgrade()">Upgrade</a>-->
											 ...
											 if($subscriptionname=='Y1')
											 {
												...
												?>
												  ...
												  <tbody>
													<tr  class="rpttext2">
													  <th class="col-sm-2 greene" style="color: red !important;">Yearly</th>
													  <th class="col-sm-2 greene">Subscription Payment Yearly</th>
													  <th class="col-sm-2 greene"><?php echo $subscription[0]->created_at;?></th>
													   <th class="col-sm-2 greene" style="color: red !important;">
													   <?php 
													    $currentdate=date('Y-m-d H:i:s');
													   ...
													   <th class="col-sm-2 greene">$197 / Yearly</th>
													   <th class="col-sm-2 greene">
													   <a href="javascript:void(0);" 
													   ng-click="canclesubscription(<?php echo $subscription[0]->user_id;?>,'<?php echo $subscription[0]->str_id;?>','<?php echo $subscription[0]->str_sub_id;?>')">Cancle</a>
													   /<!--<a href="javascript:void(0);" ng-click="showupgrade()">Upgrade</a>-->
													   <a href="javascript:void(0);" >Upgrade</a></th>
													</tr>
