...
$td = array();
$c=0;
foreach($html->find('table') as $element1) // find tr element inside the table 
{
	 /* $td1 = array();
	  $td2 = array(); */
	//$td []='';
/* foreach($html->find('tr') as $element)
{
	...
	//fputcsv($fp, $td1);
	foreach( $element->find('td') as $row) // look for th tag and it to the array if it exists.
    {
        $td2 [] = $row->plaintext;
    }
    fputcsv($fp, $td2);
        ...
        <div class="col-md-12 graphs">
			...
			<div class="row" id="alltable">		
			  ...
			  <!--<table class="table table-bordered firsttable table-striped">-->
				...
				<tbody>
				 <tr>
					<td class="text-l">Sales</td><td >{{sales | currency}}</td>
				  </tr>
				  <tr>
					<td class="text-l">Orders</td><td>{{orders}}</td>
				  </tr>
				 <tr ng-repeat="value in products">
				   <td class="text-l" title="{{value.product}}" tooltip-placement="left">{{value.product|limitTo: 25}}...</td><td>{{value.order}}</td>
				  </tr>
				  
				  <tr>
					<td class="text-l Ads">Ads</td><td class="Ads" >{{fb_conversion | currency}}</td>
				  </tr>
				  <tr>
					<td class="text-l">Supplier Cost</td><td>{{suppliertotal_cost | currency}}</td>
					
				  </tr>
				  <tr>
					<td class="text-l">Fulfillment</td><td>{{fulfillment * orders | currency}}</td>
					
				  </tr>
				  <tr>
					<td class="text-l">Gateway Cost</td><td>{{stripe_order | currency}}</td>
				  </tr>
				   <tr>
					<td class="text-l">Miscellaneous Cost</td><td>{{miscosts | currency}}</td>
				  </tr>
				  <tr>
			...
			<div class="form-group">
			  ...
			  <button type="submit" name="csvcreate" class=" sfbtn">Download CSV</button>
