    ...
    <section class="content">
        ...
        <div class="col-md-12 graphs">
			...
			<!-- <div class="form-group">
              <form action="" method="post"><button type="submit" name="csvcreate" class=" sfbtn">Download CSV</button>
			  </form>
			  <a type="button" name="csvcreate" class="export sfbtn">Download CSV</a>
            </div>-->
<div id="dvData">
  <table>
    <tr>
