...
$conn = mysqli_connect("profitandlossdb.cmoz4y1ejcgl.us-east-1.rds.amazonaws.com","profitandloss","|DoiELHXSiD8Rbp*","profitandlossdb01");
...
if(isset($_POST['contact_submit']))
{
	...
	$message=$_POST['message'];
						...
						if($subject1=='Sales')
						{
							$to = "info@profitandloss.io,".$email;
						}
						if($subject1=='Technical Support')
						{
							$to = "support@profitandloss.io,".$email;
						}
						if($subject1=='Billing')
						{
							$to = "support@profitandloss.io,".$email;
						}
						if($subject1=='Customer Care')
						{
							$to = "support@profitandloss.io,".$email;
						}
						if($subject1=='Marketing')
						{
							$to = "support@profitandloss.io,".$email;
						}
						if($subject1=='Media')
		                ...
		                //$to = "register@profitandloss.io,".$email;
			...
			<div class="row">
				<div class="col-md-6 animate-box">
					...
					<?php } ?>
					 <form action="" method="POST" id="contact-form">
						...
						<div class="g-recaptcha" data-sitekey="6LdT4DEUAAAAAIibk1l9F5MEbgVExsuP3Tw6lfAo" ></div>
				...
				<div class="col-md-5 col-md-push-1 animate-box">
					...
					<div class="gtco-contact-info">
						...
						<ul>
							<li class="address">12030 Citrus Leaf Dr<br>Gibsonton, FL 33534</li>
							<!--<li class="phone"><a href="tel://1234567920">+ 1235 2355 98</a></li>-->
							<li class="email"><a href="mailto:info@yoursite.com">info@profitandloss.io</a></li>
							<li class="url"><a href="<?php echo base_url();?>">www.profitandloss.io</a></li>
						</ul>
					</div>
