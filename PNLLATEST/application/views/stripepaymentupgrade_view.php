...
if(isset($user_id)&&isset($str_customer_id))
{
	...
	//exit;
		   ...
		   $message ='<table width="480" cellspacing="0" cellpadding="0" border="0">
							...
							<p><a href="<?php echo base_url();?>login">Please click to Login.</a></p>
							<br>
				...
				header('Location: <?php echo base_url();?>profile?status=1');
				 //echo  1;
				...
				$error = $e->getMessage();
					//$result = "declined";
					//echo  0;
					header('Location: <?php echo base_url();?>profile?status=0');
