	 ...
	 <div class="container-fluid toppadd">
      ...
      <div class="col-md-2"></div>
          ...
          <!--<div class="col-md-2 no-pad topmar">
           ...
           <div class="col-md-2 no-pad topmar">
              <form action="<?php echo base_url();?>index.php/stripepayment/index" method="POST" id="payment-form">
              ...
              <div  class="allbox box2" >
                ...
                Basic Account
                  ...
                  <select name="package" class="mypro1">
					...
					<option  value="plan1B,497">1 Year - $197  </option>
				  </select>
              ...
              <div  class="allbox box2" >
                ...
                Professional Account
                  ...
                  <select name="package" class="mypro1">
					...
					<option  value="plan2B,697">1 Year - $397  </option>
				  </select>
              ...
              <div  class="allbox box2" >
                ...
                Business Account
                  ...
                  <select name="package" class="mypro1">
					...
					<option  value="plan3B,897">1 Year - $597  </option>
				  </select>
